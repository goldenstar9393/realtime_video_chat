...
const About = () => {
    return (
        ...
        <div className=''>
            ...
            <div>
                <section className='bg-[#212121]  lg:h-[70vh] md:h-[97vh] sm:h-[80vh] w-full mx-auto lg:px-16 md:px-10 sm:px-6 px-4 py-16 flex lg:flex-row flex-col gap-6 justify-between items-center '>
            ...
            <section className='mt-[99px] w-full mx-auto mb-20'>
